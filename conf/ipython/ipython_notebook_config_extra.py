...
import os  # We need to lookup some things from environment variables.
...
c.NotebookApp.profile = u'{0}'.format(os.environ['IPYTHON_PROFILE'])
...
# variable IPYTHONDIR.
# c.NotebookApp.ipython_dir = u'/Users/ipy/.ipython'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPKernelApp.ipython_dir = u'/Users/ipy/.ipython'
...
# c.NotebookManager.notebook_dir = u'/Users/ipy'
c.NotebookManager.notebook_dir = u'{0}'.format(os.environ['IPYTHON_NOTEBOOKSDIR'])
